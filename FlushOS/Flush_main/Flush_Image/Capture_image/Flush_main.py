...
if __name__ == "__main__":
    ...
    Path_Symbol = r'C:\Users\aminb\Documents\GitHub\flush_bot\FlushOS\Flush_main\Flush_Image\Capture_image\Image\Symbol\*.jpg'
    PATH_Image = Flush_ImageProcessing(Image,Path_Symbol,method = "thining")
